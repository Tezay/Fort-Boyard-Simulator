...
from .mathematic_challenge import factorialChallenge, primeNumberChallenge, linearEquationChallenge , rouletteChallenge, findPrimeNumberChallenge, squareChallenge # A compléter
