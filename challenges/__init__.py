...
from .mathematic_challenge import factorialChallenge, primeNumberChallenge, linearEquationChallenge , rouletteChallenge , findPrimeNumberChallenge# A compléter
